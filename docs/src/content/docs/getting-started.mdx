...
1. `starlight-automatic-overview-pages` is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it by running the following command in your terminal:
   ...
   ```sh
   npm install starlight-automatic-overview-pages
   ```
   ...
   ```sh
   pnpm add starlight-automatic-overview-pages
   ```
   ...
   ```sh
   yarn add starlight-automatic-overview-pages
   ```
