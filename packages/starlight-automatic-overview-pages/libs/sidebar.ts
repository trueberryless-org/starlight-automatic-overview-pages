...
import type { StarlightAutomaticOverviewPagesSharedConfig } from "./config";
...
export function getCurrentTopic(
  config: StarlightAutomaticOverviewPagesSharedConfig,
...
export interface Topic {
  config: StarlightAutomaticOverviewPagesSharedConfig[number];
  sidebar: SidebarEntry[];
